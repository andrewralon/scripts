...
$things = @(
	...
	#, [Thing]::new([Action]::Play, $true, $false, [Cmd]::new("multimonitortool /enable 2"))
	...
	, [Thing]::new([Action]::Work, $false, $false, [App]::new("Chrome", "${env:ProgramFiles(x86)}\Google\Chrome\Application\chrome.exe", "--profile-directory='Default'"))
