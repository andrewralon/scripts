...
:OPENJIRASEARCH
SET URL="%URLBASE%/browse/OPS-1891?jql=project%%20in%%20(OPS%%2C%%20DS%%2C%%20DEVOPS%%2C%%20CORE%%2C%%20GN1%%2C%%20GNC)%%20AND%%20text%%20~%%20%%22%*%%22%%20ORDER%%20BY%%20key%%20DESC%%2C%%20priority%%20DESC"
GOTO :RUN
